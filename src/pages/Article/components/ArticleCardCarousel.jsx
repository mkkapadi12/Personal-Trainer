...
const ArticleCardCarousel = ({ article }) => {
  return (
    <CarouselItem className="basis-1/1 sm:basis-1/2 md:basis-1/3 lg:basis-1/4">
      <div className="p-1">
        <Card className="rounded-none bg-black hover:border-amber-300 p-0 hover:border border-none">
          <CardContent className="flex flex-col md:aspect-9/14 items-start justify-between p-0 relative">
            {/* image */}
